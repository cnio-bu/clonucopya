...
comparative analysis (read [Main applications](#main-applications) section for futher details). Each study is stored at Once the workflow execution is completed, you can check the results of the study at `clonucopya/workflow/results`. The tree of files of the output is as it  follows:
